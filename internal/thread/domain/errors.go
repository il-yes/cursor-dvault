...
var (
	...
	ErrChannelGatedSlotsIncomplete = errors.New("channel gated slots are incomplete")
	ErrWorkspaceMismatch         = errors.New("workspace ID does not match channel workspace")
