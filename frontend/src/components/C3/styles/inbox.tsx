// frontend/src/components/C3/styles/inbox.tsx
import { Global, css } from '@emotion/react';

export const c3InboxStyles = css`
  .inbox-main {
    flex: 1;
    display: flex;
  ...
  /* Sidebar */
    .sidebar { width: 196px; background: #fafafa; border-right: 1px solid #ebebeb; display: flex; flex-direction: column; padding: 18px 0 16px; flex-shrink: 0; }
...
export const C3InboxStyles = () => <Global styles={c3InboxStyles} />;