			...
			>
				...
				>
					<div>
						...
						>
							Add a new thread inside your active channel context
						</div>
					</div>
					<button
						type="button"
				...
				<form onSubmit={handleSubmit}>
					...
					>
						...
						{/* Read-only Workspace & Channel Context */}
						<div
							style={{
								padding: "12px",
						...
						<div>
							...
							<input
								...
								type="text"
								placeholder="e.g. Master Service Agreement Draft, API Spec"
								value={title}
								onChange={(e) => {
						...
						<div>
							...
							<input
								...
								type="text"
								placeholder="e.g. Supplier X contract execution details"
								value={subtitle}
