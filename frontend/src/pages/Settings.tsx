					...
					<div className="space-y-8">
						...
						<Card className="backdrop-blur-xl bg-white/60 dark:bg-zinc-900/60 rounded-3xl border border-white/40 dark:border-zinc-700/40 shadow-2xl">
							<CardHeader>
								...
								<CardDescription className="text-base text-muted-foreground/80 mt-2">Configure packs and template options</CardDescription>
							</CardHeader>
							<CardContent className="space-y-7">
								{/* Storage Mode */}
								<div className="flex items-center justify-between">
									...
									<Button onClick={PackWorker}>Launch ApplyWorker</Button>
								</div>
							</CardContent>
						</Card>
