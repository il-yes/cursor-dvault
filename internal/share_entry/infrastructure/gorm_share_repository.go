...
func (m *ShareEntryModel) ToDomain() share_entry_domain.ShareEntry {
	var snap share_entry_domain.EntrySnapshot
	_ = json.Unmarshal(m.EntrySnapshot, &snap)

	recipients := make([]share_entry_domain.Recipient, len(m.Recipients))
	for i, r := range m.Recipients {
		recipients[i] = share_entry_domain.Recipient{
			ID:            string(r.ID),
	...
	return share_entry_domain.ShareEntry{
		ID:            m.ID,
		OwnerID:       m.OwnerID,
...
func (m *RecipientModel) ToDomain() share_entry_domain.Recipient {
	return share_entry_domain.Recipient{
		ID:            string(m.ID),
...
func (r *GormShareRepository) ListByUser(userID string) ([]share_entry_domain.ShareEntry, error) {
...
// ----------------------------------------------
func (r *GormShareRepository) ListReceivedByUser(recipientID string) ([]share_entry_domain.ShareEntry, error) {
	var shares []share_entry_domain.ShareEntry
...
) (*share_entry_domain.ShareEntry, *share_entry_domain.Recipient, []byte, error) {
...
// ---------------------------------------------------------
func (r *GormShareRepository) GetShareAndRecipient(ctx context.Context, shareID string, userID string) (*share_entry_domain.ShareEntry, *share_entry_domain.Recipient, error) {

	var share share_entry_domain.ShareEntry
	if err := r.db.
		Preload("Recipients").
		Where("id = ?", shareID).
		First(&share).Error; err != nil {
		return nil, nil, share_entry_domain.ErrShareNotFound
	}
	...
	return nil, nil, share_entry_domain.ErrRecipientNotAllowed
}
...
// Add Recipient
// ---------------------------------------------------------
func (r *GormShareRepository) GetShareByID(ctx context.Context, shareID string) (*share_entry_domain.ShareEntry, error) {
	var share share_entry_domain.ShareEntry
...
func (r *GormShareRepository) CreateRecipient(ctx context.Context, rec *share_entry_domain.Recipient) error {
...
// Create Share
// ---------------------------------------------------------
// func (r *GormShareRepository) CreateShare(ctx context.Context, s *share_entry_domain.ShareEntry) error {
...
func toDomainList(models []ShareEntryModel) []share_entry_domain.ShareEntry {
	res := make([]share_entry_domain.ShareEntry, 0, len(models))
...
func (r *GormShareRepository) GetByID(id string) (*share_entry_domain.ShareEntry, error) {
...
func (r *GormShareRepository) Save(entry *share_entry_domain.ShareEntry) error {
...
func toModel(e share_entry_domain.ShareEntry) (*ShareEntryModel, error) {
