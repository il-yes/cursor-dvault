...
func (u *ChannelSlotUsecase) UpdateSlot(ctx context.Context, req channel_application.UpdateSlotRequest) (*channel_domain.Channel, error) {
	if err := u.ValidateDependencies(); err != nil {
		return nil, err
	}

	if err := u.validateUpdateSlotRequest(req); err != nil {
		return nil, err
	}
	...
	if err := channel.Data.UpdateSlot(req.Slot); err != nil {
		return nil, err
	}
