...
func (u *ChannelAssignmentUsecase) AddAssignment(ctx context.Context, req channel_application.AddAssignmentRequest) (*channel_domain.Channel, error) {
	if err := u.ValidateDependencies(); err != nil {
		return nil, err
	}

	if err := u.validateAddAssignmentRequest(req); err != nil {
		return nil, err
	}
	...
	// if err := channel.Data.AddAssignment(req.Assignment); err != nil {
	// 	return nil, err
	// }
