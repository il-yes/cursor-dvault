  ...
  const handleAttachments = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${attachments.length} file(s) saved`,
      });
      ...
      toast({
        title: "Upload failed",
        description: "Could not save attachments",
        variant: "destructive",
      });
    } finally {
        ...
        <div className="space-y-3 space-x-3">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-primary/20 to-amber-500/20 backdrop-blur-sm border-primary/30 text-primary font-semibold px-3 py-1 shadow-md"
            >
              Upload
            </Button>
          </div>
