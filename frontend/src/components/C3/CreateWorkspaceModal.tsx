			...
			>
				...
				>
					<div>
						...
						>
							Define a new collaboration substrate workspace
						</div>
					</div>
					<button
						type="button"
					...
					>
						...
						<div>
							...
							<input
								...
								type="text"
								placeholder="e.g. Acme Corp, Enterprise Vault"
								value={name}
								onChange={(e) => {
						...
						<div>
							...
							>
								Description{" "}
								<span style={{ color: "#8B949E", fontWeight: 400, textTransform: "none" }}>
									(optional)
								</span>
							</label>
							<textarea
								id="workspace-desc-input"
								placeholder="Add a brief description for this C3 collaboration workspace…"
								value={description}
