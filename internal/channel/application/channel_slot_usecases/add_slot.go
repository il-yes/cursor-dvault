...
func (u *ChannelSlotUsecase) AddSlot(ctx context.Context, req channel_application.AddSlotRequest) (*channel_domain.Channel, error) {
	if err := u.ValidateDependencies(); err != nil {
		return nil, err
	}

	if err := u.validateAddSlotRequest(req); err != nil {
		return nil, err
	}
	...
	if err := channel.Data.AddSlot(req.Slot); err != nil {
		return nil, err
	}
